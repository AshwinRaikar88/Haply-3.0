...
public class PositionMapperWithTCPStatus : MonoBehaviour
{
    ...
    public TMPro.TextMeshProUGUI xUnityLbl;  
    public TMPro.TextMeshProUGUI yUnityLbl;  

    public TMPro.TextMeshProUGUI zUnityLbl;  
    public TMPro.TextMeshProUGUI xXarmLbl;  
    public TMPro.TextMeshProUGUI yXarmLbl;  
    public TMPro.TextMeshProUGUI zXarmLbl;  
    ...
    private void SendPosition()
    {
        ...
        xUnityLbl.text = "x Unity:" + u.x.ToString("F2", CultureInfo.InvariantCulture);
        yUnityLbl.text = "y Unity:" + u.y.ToString("F2", CultureInfo.InvariantCulture);
        zUnityLbl.text = "z Unity:" + u.z.ToString("F2", CultureInfo.InvariantCulture);
        ...
        xXarmLbl.text = "x Xarm:" + sx;
        yXarmLbl.text = "y Xarm:" + sy;
        zXarmLbl.text = "z Xarm:" + sz;
